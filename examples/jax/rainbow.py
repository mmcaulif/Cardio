    ...
    def __init__(
        ...
        def _update(train_state: TrainState, targ_params, s, a, r, s_p, d, w):
            def loss_fn(params, train_state: TrainState, s, a, r, s_p, d, w):
                q_logits = jax.vmap(train_state.apply_fn, (None, 0))(params, s).q_logits
                q_p_logits = jax.vmap(train_state.apply_fn, (None, 0))(
                    targ_params, s_p
                ).q_logits
                q_p = jax.vmap(train_state.apply_fn, (None, 0))(params, s_p).q_values
